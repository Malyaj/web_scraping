...
'''module for dataframe, export to excel'''
import pandas as pd
...
def query_widget():
    ...
    query_entry = ttk.Entry(mainframe, show = '*', width=50, textvariable=query)
...
### testing
search_string = query_widget()
#search_string = 'WR23X10179'
#search_string = 'moto g5s plus'
...
#col = 0
#
#for key in dict_product_info.keys():
#    row += 1
#    worksheet.write(row, col, key)
#    for item in dict_product_info[key]:
...
for asin in dict_product_info:
    dict_product_info[asin].to_excel(writer, sheet_name=asin)

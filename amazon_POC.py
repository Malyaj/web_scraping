...
def search_yield(search_string):  # returns list of ASINs if search returns results, else None
    ...
    try:
        ...
        ASINs = search_page_results(search_string)
        return ASINs
...
def create_url(ASIN, page_no=1, index=0):  # returns the first page of the ASIN search results
    base, ref, utf = "https://www.amazon.in/gp/offer-listing/", "/ref=olp_page_", "?ie=UTF8&startIndex="
